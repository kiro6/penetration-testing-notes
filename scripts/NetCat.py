...
#this is the simple version of netcat using python i wrote it while practice scripting and automation 
...
class NetCat:
    ...
    def send(self):
        ...
        try:
            ...
            print("Connection timeout: The server did not respond within 5 seconds.")
            self.socket.close()
            sys.exit()
